...
const customClass = computed(() => {
  return `custom-time-range-picker-${props.compSize} ${props.class}`;
});
let bindValue = ref([]);
...
<style lang="less">
.custom-time-range-picker-superLarge.el-date-editor.el-input__wrapper {
  height: 52px;
  .el-range-input,
  .el-input__icon,
  .el-range-separator {
...
.custom-time-range-picker-big.el-date-editor.el-input__wrapper {
  height: 48px;
  .el-range-input,
  .el-input__icon,
  .el-range-separator {
...
.custom-time-range-picker-large.el-date-editor.el-input__wrapper {
  height: 44px;
...
.custom-time-range-picker-default.el-date-editor.el-input__wrapper {
  height: 40px;
...
.custom-time-range-picker-medium.el-date-editor.el-input__wrapper {
  height: 36px;
...
.custom-time-range-picker-small.el-date-editor.el-input__wrapper {
  height: 32px;
...
.custom-time-range-picker-mini.el-date-editor.el-input__wrapper {
  height: 28px;
