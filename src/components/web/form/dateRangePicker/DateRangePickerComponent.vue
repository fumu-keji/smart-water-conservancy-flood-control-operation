...
const customClass = computed(() => {
  return `custom-date-range-picker-${props.compSize} ${props.class}`;
});
let bindValue = ref([]);
...
<style lang="less">
.custom-date-range-picker-superLarge.el-date-editor.el-input__wrapper {
  height: 52px;
  .el-range-input,
  .el-input__icon,
  .el-range-separator {
...
.custom-date-range-picker-big.el-date-editor.el-input__wrapper {
  height: 48px;
  .el-range-input,
  .el-input__icon,
  .el-range-separator {
...
.custom-date-range-picker-large.el-date-editor.el-input__wrapper {
  height: 44px;
...
.custom-date-range-picker-default.el-date-editor.el-input__wrapper {
  height: 40px;
...
.custom-date-range-picker-medium.el-date-editor.el-input__wrapper {
  height: 36px;
...
.custom-date-range-picker-small.el-date-editor.el-input__wrapper {
  height: 32px;
...
.custom-date-range-picker-mini.el-date-editor.el-input__wrapper {
  height: 28px;
